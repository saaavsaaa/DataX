#!/usr/bin/env python
# -*- coding:utf-8 -*-
# exec.sh : find ./ -name "*.json" -exec python datax.py {} \;
# java -server -Xms1g -Xmx1g -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=E:\Github\DataX\target\datax\datax/log -Xms1g -Xmx1g -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=E:\Github\DataX\target\datax\datax/log -Dloglevel=info -Dfile.encoding=UTF-8 -Dlogback.statusListenerClass=ch.qos.logback.core.status.NopStatusListener -Djava.security.egd=file:///dev/urandom -Ddatax.home=E:\Github\DataX\target\datax\datax -Dlogback.configurationFile=E:\Github\DataX\target\datax\datax/conf/logback.xml -classpath E:\Github\DataX\target\datax\datax/lib/*  -Dlog.file.name=\datax\bin\test_json com.alibaba.datax.core.Engine -mode standalone -jobid -1 -job E:\Github\DataX\target\datax\datax\bin\test.json
